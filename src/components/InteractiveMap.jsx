...
const InteractiveMap = ({ onLocationSelect, initialLat, initialLng }) => {
  ...
  return (
    <div className="space-y-4">
          ...
          <div>
            {locationLoading ? (
              ...
              <p className="text-gray-600">
                📍 Your current location will be used for this issue.
              </p>
            )}
          </div>
        ) : (
          <p className="text-gray-600">
            🗺️ Click anywhere on the map to select a location for this issue.
          </p>
        )}
      </div>
      ...
      <DirectLeafletMap
        onLocationSelect={
          !useCurrentLocation ? handleLocationSelect : undefined
        }
        selectedLocation={
          !useCurrentLocation ? selectedLocation : currentLocation
        }
        height="300px"
